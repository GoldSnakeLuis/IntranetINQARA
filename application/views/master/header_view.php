    ...
    <section class="body">
        ...
        <header class="header">
            <div class="logo-container">
                <a href="<?php echo MAIN_URL; ?>/Dashboard" class="logo">						
                    <img src="<?php echo URL_ASSETS ?>img/logo.png" width="75" height="35" alt="Porto Admin" />					
                </a>					<div class="d-md-none toggle-sidebar-left" data-toggle-class="sidebar-left-opened" data-target="html" data-fire-event="sidebar-left-opened">						<i class="fa fa-bars" aria-label="Toggle sidebar"></i>					</div>
            </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <a href="#" class="clearfix">
                                                            <figure class="image">
                                                                <img src="<?php echo URL_ASSETS ?>img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
                                                            </figure>
                                                    ...
                                                    <li>
                                                        <a href="#" class="clearfix">
                                                            <figure class="image">
                                                                <img src="<?php echo URL_ASSETS ?>img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
                                                            </figure>
                                                    ...
                                                    <li>
                                                        <a href="#" class="clearfix">
                                                            <figure class="image">
                                                                <img src="<?php echo URL_ASSETS ?>img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
                                                            </figure>
